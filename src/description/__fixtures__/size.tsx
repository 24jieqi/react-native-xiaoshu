    ...
    <Space>
      ...
      <Card title="size:单独设置" square>
        <Description.Group size="s">
          <Description label="标题的题" text="一袋米要抗几楼" size="l" />
          <Description label="标题的题" text="一袋米要抗二楼" />
          <Description label="标题的题" text="一袋米要给多了" />
          <Description label="标题的题" text="一袋米由我洗嘞" />
        </Description.Group>
      ...
      <Card title="size:单独设置" square>
        <Description.Group>
          <Description label="标题的题 l" text="一袋米要抗几楼" size="l" />
          <Description label="标题的题 m" text="一袋米要抗二楼" size="m" />
          <Description label="标题的题 s" text="一袋米要给多了" size="s" />
        </Description.Group>
      </Card>
    </Space>
  )
